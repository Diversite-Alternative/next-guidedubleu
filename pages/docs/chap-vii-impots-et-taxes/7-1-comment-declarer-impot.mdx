...
<CustomTitle tag="h1"  size="24px">
    7.1 Comment s’effectue la déclaration d’impôt
</CustomTitle>
...
import impots from './import-gouv.png'
import infos from './infos-perso.png'
import annexe from './annexes.png'
import revenus from './revenus.png'

<CustomImage2 src={impots} alt="Déclaration de revenu" width={500} height={500} center={true} />

Ensuite, il faut accéder à son espace pour renseigner ses informations personnelles.


<CustomImage2 src={infos} alt="Infos personnels" width={500} height={500} center={true} />
...
<CustomImage2 src={annexe} alt="Annexes" width={500} height={500} center={true} />
...
<CustomImage2 src={revenus} alt="revenus" width={500} height={500} center={true} />
