...
• Votre **réservation de logement** imprimée (cf. partie Logement 2.1.1)

• Les **documents demandés** pour l’entrée dans le logement (cf. partie Logement 2.1.1)
...
• Votre **liste de contacts** (cf. partie Logement 2.1.1)
...
import img from './jours-ferie-en-france.png'
