...
export default {
  ...
  project: {
    link: 'https://github.com/Diversite-Alternative/next-guidedubleu'
  },
  head: () => {
  ...
  banner: {
    key: '2.0-release',
    text: (
      <a href="https://github.com/Diversite-Alternative/next-guidedubleu" target="_blank">
        🎉 v4.0 Nouvelle version. En savoir plus →
      </a>
    )
  },
  chat: {
